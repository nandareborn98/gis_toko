...
<html lang="id">
  <head>
    ...
    <meta name="description" content="Source Code Sistem Informasi Geografis / Geographic Information System (GIS) berbasis web dengan PHP dan MySQL. Studi kasus: toko ikan hias di kota jambi."/>
   ...
   <meta name="author" content="sarjanakomedi.com"/> 
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBv3dI8TNXqDZHkukNn3-ddkXjf4X2-XKo&language=id&region=ID"></script>
  ...
  <body>
    ...
    <footer class="footer bg-primary">
      <div class="container">
        <p>Copyright &copy; <?=date('Y')?> nandaa  <em class="pull-right">2020</em></p>
      </div>
    </footer>
</body>
</html>